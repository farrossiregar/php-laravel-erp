...
class DashboardSpeedWarning extends Component
{
    public $projects=[];

    public function render()
    {
        return view('livewire.performance-kpi.dashboard-speed-warning');
    }

    public function mount()
    {
        \LogActivity::add('[web] Performance KPI Dashboard Speed Warning');
