...
class DashboardVehicleCheck extends Component
{
    public $projects=[];

    public function render()
    {
        return view('livewire.performance-kpi.dashboard-vehicle-check');
    }

    public function mount()
    {
        \LogActivity::add('[web] Performance KPI Dashboard Vehicle Check');
