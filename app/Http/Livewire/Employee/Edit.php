...
class Edit extends Component
{
    ...
    {   
        $this->validate([
            'name' => 'required',
            'nik' => ['required',Rule::unique('employees')->ignore($this->data)->whereNull('deleted_at')],
            //'place_of_birth' => 'required',
            //'date_of_birth' => 'required',
            //'marital_status' => 'required',
            //'blood_type' => 'required',
            'email' => ['required','email',Rule::unique('employees')->ignore($this->data)->whereNull('deleted_at')],
