...
class Materialcriteria extends Component
{    
    protected $listeners = [
        'modalmaterialcriteria'=>'materialcriteria',
    ];
    ...
    {
        return view('livewire.vendor-management.materialcriteria');        
    }

    public function materialcriteria($id)
    {
        $this->selected_id = $id;
    ...
    public function save()
    {
        ...
        session()->flash('message-success',"Supplier Material Successfully Evaluate!!!");
