...
use App\Models\DutyrosterFlmengineerMaster;
...
class Dashboard extends Component
{
    ...
    public $labels;
    public $datasets;
    public $labelsorgflm,$color = ['#ffb1c1','#4b89d6','#add64b','#80b10a','#007bff','#28a745','#333333','#c3e6cb','#dc3545','#6c757d'];
    ...
    public function generate_chart()
    {
        ...
        for($bulan=1;$bulan<=12;$bulan++) {
            $count = DutyrosterFlmengineerMaster::whereMonth('created_at',$bulan)->whereYear('created_at',$this->year)->get()->count();
            $this->datasets[0]['data'][] = $count?$count:0;
        }
