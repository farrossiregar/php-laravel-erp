...
class Approvedeductionregional extends Component
{
    protected $listeners = [
        'modalapprovedeductionregional'=>'approvedeductionregional',
    ];
    ...
    {       
        ...
        return view('livewire.po-tracking-ms.approvedeductionregional');
    }

    public function approvedeductionregional($id)
    {
        $this->selected_id = $id;
