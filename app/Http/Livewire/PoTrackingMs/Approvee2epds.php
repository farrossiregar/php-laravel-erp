...
class Approvee2epds extends Component
{
    protected $listeners = [
        'modalapprovee2epds'=>'approvee2epds',
    ];
    ...
    {       
        ...
        return view('livewire.po-tracking-ms.approvee2epds');
    }

    public function approvee2epds($id)
    {
        $this->selected_id = $id;
