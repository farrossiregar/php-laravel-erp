...
class Declinepmgreview extends Component
{
    protected $listeners = [
        'modaldeclinepmgreview'=>'declinepmgreview',
    ];
    ...
    {       
        ...
        return view('livewire.po-tracking-ms.declinepmgreview');
    }

    public function declinepmgreview($id)
    {
        $this->selected_id = $id;
