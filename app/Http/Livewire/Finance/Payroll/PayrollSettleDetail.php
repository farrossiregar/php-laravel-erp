...
class PayrollSettleDetail extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.finance.payroll.payroll-settle-detail');
    }

    public function set_id(AccountPayablePayroll $data)
    {
