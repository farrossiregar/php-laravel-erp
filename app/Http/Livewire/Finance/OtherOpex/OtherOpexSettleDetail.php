...
class OtherOpexSettleDetail extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.finance.other-opex.other-opex-settle-detail');
    }

    public function set_id(AccountPayableOtheropex $data)
    {
