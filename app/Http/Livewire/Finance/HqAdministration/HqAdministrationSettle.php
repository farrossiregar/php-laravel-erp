...
class PettyCashSettle extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.finance.petty-cash-settle');
    }
    ...
    public function save()
    {
        ...
        if($this->total_difference){
            ...
            $budget = PettyCashBudget::where(['company_id'=>session()->get('company_id'),'department_id'=>$this->data->employee->department_id])->first();
            if($budget){
