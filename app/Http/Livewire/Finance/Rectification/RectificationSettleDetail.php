...
class RectificationSettleDetail extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.finance.rectification.rectification-settle-detail');
    }

    public function set_id(AccountPayableRectification $data)
    {
