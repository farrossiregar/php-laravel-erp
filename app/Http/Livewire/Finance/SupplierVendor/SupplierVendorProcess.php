...
class SupplierVendorProcess extends Component
{
    ...
    public function render()
    {
        ...
        return view('livewire.finance.suppliervendor.suppliervendor-process');
    }

    public function check_id(AccountPayableSuppliervendor $selected)
    {
