...
class SubcontSettleDetail extends Component
{
    use WithFileUploads;
    ...
    {
        return view('livewire.finance.subcont.subcont-settle-detail');
    }

    public function set_id(AccountPayableSubcont $data)
    {
    ...
    public function save()
    {
        ...
        return redirect()->route('subcont.index');
    }
}
