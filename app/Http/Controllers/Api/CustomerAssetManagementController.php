...
class CustomerAssetManagementController extends Controller
{
    ...
    public function submit(Request $r)
    {
        ...
        if(isset($r->qty_module_1))$data->qty_module_1 = $r->qty_module_1;
        if($r->battery_brand_1)$data->battery_brand_1 = $r->battery_brand_1;
        if(isset($r->battery_qty_1))$data->battery_qty_1 = $r->battery_qty_1;
        if(isset($r->qty_module_2))$data->qty_module_2 = $r->qty_module_2;
        if($r->battery_brand_2)$data->battery_brand_2 = $r->battery_brand_2;
        if(isset($r->battery_qty_2))$data->battery_qty_2 = $r->battery_qty_2;
        if(isset($r->qty_module_3))$data->qty_module_3 = $r->qty_module_3;
        if($r->battery_brand_3)$data->battery_brand_3 = $r->battery_brand_3;
        if(isset($r->battery_qty_3))$data->battery_qty_3 = $r->battery_qty_3;
