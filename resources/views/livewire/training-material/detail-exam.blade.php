                    ...
                    <table class="table m-b-0 c_list">
                        ...
                        @foreach(\App\Models\TrainingExamResult::where(['training_material_id'=>$data->id])->get() as $k => $result)
                            <tr>
                                ...
                                <td><a href="{{route('training-material.detail-exam-employee',['id'=>$result->training_material_id,'employee_id'=>$result->employee_id])}}" class="badge badge-info">See Result</a></td>
                            </tr>
                        @endforeach
                        </tbody>
                    </table>
