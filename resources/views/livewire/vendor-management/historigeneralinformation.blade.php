            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div style="border: 1px solid lightgrey; border-radius: 5px; padding: 10px; margin: 5px;">
                        <?php
                            $check_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->get();
                        ?>
                        <!-- <?php echo $date; ?> -->
                        <div class="row">
                                        ...
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    ...
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '1')->first();
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '2')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '3')->first();
                                                    $count = $get_data['value'];
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '4')->first();
                                                    $count = $get_data['value'];
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '5')->first();
                                                    $count = $get_data['value'];
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '6')->first();
                                                    $count = $get_data['value'];
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '7')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '8')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '9')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '10')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '11')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '12')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '13')->first();
                                                    $count = $get_data['value'];
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '14')->first();
                                                    $count = $get_data['value'];
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '15')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '16')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '17')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '18')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '19')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '20')->first();
                                            $count = $get_data['value'];      
                                    ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '21')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '22')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '23')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '24')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                            ...
                            <div class="col-md-8">
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '25')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <?php
                                                if(count($check_data) > 0){
                                                    $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '26')->first();
                                                    $count = $get_data['value'];      
                                            ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '27')->first();
                                            $count = $get_data['value'];      
                                    ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '28')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '29')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '30')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '31')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '32')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '33')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '34')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '35')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '36')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '37')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '38')->first();
                                            $count = $get_data['value'];      
                                    ?>
                    ...
                    <div style="border: 1px solid lightgrey; border-radius: 5px; padding: 10px; margin: 5px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '39')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '40')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '41')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '42')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '43')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                ...
                                <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '44')->first();
                                            $count = $get_data['value'];      
                                    ?>
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    <?php
                                        if(count($check_data) > 0){
                                            $get_data = \App\Models\VendorManagementgi::where('id_supplier', $selected_id)->whereDate('created_at', date_format(date_create($date), 'Y-m-d') )->where('id_detail', '45')->first();
                                            $count = $get_data['value'];      
                                    ?>
