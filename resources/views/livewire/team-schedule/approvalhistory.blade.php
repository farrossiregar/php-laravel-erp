<form wire:submit.prevent="save">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-check"></i> Approval History Team Schedule</h5>
    ...
    <div class="modal-body">
        <div class="container py-2 mt-4 mb-4">
            @foreach(\App\Models\LogActivity::where('subject', 'Approvalhistoryteamschedule'.$selected_id)->orderBy('id', 'desc')->get() as $k => $item)
            <div class="row">
                <div class="col-auto text-center flex-column d-none d-sm-flex">
                    ...
                    <div class="row h-40">
                        @if($k != (count(\App\Models\LogActivity::where('subject', 'Approvalhistoryteamschedule'.$selected_id)->orderBy('id', 'desc')->get()) - 1))
                        <div class="col" style="border-right: 3px solid lightgray;">&nbsp;</div>
                        @endif
                        <div class="col">&nbsp;</div>
                    </div>
