<form wire:submit.prevent="save">
    ...
    <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-close"></i> Update Business Opportunity to Failed</h5>
    ...
    <div class="modal-body">
        <div class="form-group">
            <label> Update Business Opportunity to Failed ?</label>
        </div>
        <div class="form-group">
            <label>Note</label>
