                    ...
                    <tr>
                        <?php
                            if($this->filtermonth && $this->filteryear){
                                $datatoolsnoc = \App\Models\ToolsNoc::where('type', '2')->where('nik', $item->nik)->where('month', $this->filtermonth)->where('year', $this->filteryear);
                            }elseif($this->filtermonth == '' && $this->filteryear){
                                $datatoolsnoc = \App\Models\ToolsNoc::where('type', '2')->where('nik', $item->nik)->where('month', date('m'))->where('year', $this->filteryear);
                            }elseif($this->filtermonth && $this->filteryear == ''){
                                $datatoolsnoc = \App\Models\ToolsNoc::where('type', '2')->where('nik', $item->nik)->where('month', $this->filtermonth)->where('year', date('Y'));
                            }else{
                        ...
                        <td>{{ $key + 1 }}</td>
                        <td>{{$item->nik}}</td>
                        <td><a href="javascript:;" wire:click="$emit('modaladdtoolsnoc',['{{ $item->id }}', '2'])" >{{ strtoupper($item->name) }}</a></td>
                        <td>
                            <?php
