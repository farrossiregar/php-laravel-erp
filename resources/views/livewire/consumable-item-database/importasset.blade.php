<form wire:submit.prevent="save">
    ...
    <div class="modal-header">
        ...
        <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-upload"></i> Upload Consumable Item Database</h5>
    ...
    <div class="modal-body">
        ...
        <a href="#" wire:click="sampleimport()"><i class="fa fa-download"></i> Download Sample Template</a>
        <br>
        <br>
        <!-- <div class="modal-footer">
