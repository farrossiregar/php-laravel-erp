        ...
        <div class="card">
            <div class="tab-content">      
                <div class="header row">
                    <h5 class="modal-title" id="exampleModalLabel"><i class="fa fa-plus"></i> Update Request Rectification </h5>
                </div>
                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6 form-group">
                                        ...
                                        <div class="col-md-6 form-group">
                                            <label>Rect Name </label>
                                            <input type="text" class="form-control" wire:model="rect_name">
                                        ...
                                        <div class="col-md-6 form-group">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-4">
                                                    <a href="<?php echo asset('storage/Account_Payable/Rectification/'.$doc_settlement) ?>" target="_blank"><i class="fa fa-download"></i> Download</a>
                                                </div>
                                            </div>
