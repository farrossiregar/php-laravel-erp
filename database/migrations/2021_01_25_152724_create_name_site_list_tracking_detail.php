...
class CreateNameSiteListTrackingDetail extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('name_site_list_tracking_detail', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('name_site_list_tracking_detail');
    }
}
