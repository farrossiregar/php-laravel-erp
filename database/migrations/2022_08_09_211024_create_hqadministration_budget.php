...
class CreateHqadministrationBudget extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Schema::create('hqadministration_budget', function (Blueprint $table) {
        //     $table->id();
        //     $table->integer('company_id')->nullable();
        //     $table->integer('client_project_id')->nullable();
        //     $table->integer('amount')->nullable();
        //     $table->smallInteger('year')->nullable();
        //     $table->integer('hqadministration_id')->nullable();
        ...
        // Schema::create('hqadministration_type', function (Blueprint $table) {
        //     $table->id();
        ...
        // Schema::create('hqadministration_item', function (Blueprint $table) {
        //     $table->id();
        //     $table->integer('hqadministration_id')->nullable();
    ...
    {
        Schema::dropIfExists('hqadministration_budget');
    }
}
