...
class CreateSubcontBudget extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        // Schema::create('subcont_budget', function (Blueprint $table) {
        //     $table->id();
        ...
        // Schema::create('subcont_type', function (Blueprint $table) {
        //     $table->id();
        ...
        // Schema::create('subcont_item', function (Blueprint $table) {
        //     $table->id();
        //     $table->integer('subcont_id')->nullable();
    ...
    {
        Schema::dropIfExists('subcont_budget');
    }
}
