...
class CreateSitekeeperBudget extends Migration
{
    ...
    public function up()
    {
        // Schema::create('sitekeeper_budget', function (Blueprint $table) {
        //     $table->id();
        //     $table->integer('company_id')->nullable();
        //     $table->integer('client_project_id')->nullable();
        //     $table->integer('amount')->nullable();
        //     $table->smallInteger('year')->nullable();
        //     $table->integer('sitekeeper_id')->nullable();
        ...
        // Schema::create('sitekeeper_type', function (Blueprint $table) {
        //     $table->id();
        ...
        // Schema::create('sitekeeper_item', function (Blueprint $table) {
        //     $table->id();
        //     $table->integer('sitekeeper_id')->nullable();
