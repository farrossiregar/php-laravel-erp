...
class CreateAccountPayableOtheropex extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('account_payable_otheropex', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('account_payable_otheropex');
    }
}
