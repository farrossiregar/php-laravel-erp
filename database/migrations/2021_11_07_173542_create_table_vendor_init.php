...
class CreateTableVendorInit extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('vendor_management_ta_init', function (Blueprint $table) {
            $table->id();
        ...
        Schema::create('vendor_management_tf_init', function (Blueprint $table) {
            $table->id();
            $table->char('id_supplier', 100)->nullable();
            $table->char('id_detail', 100)->nullable();
            $table->char('id_detail_title', 100)->nullable();
        ...
        Schema::create('vendor_management_ehs_init', function (Blueprint $table) {
            $table->id();
            $table->char('id_supplier', 100)->nullable();
            $table->char('id_detail', 100)->nullable();
            $table->char('id_detail_title', 100)->nullable();
        ...
        Schema::create('vendor_management_gi_init', function (Blueprint $table) {
            $table->id();
            $table->char('id_supplier', 100)->nullable();
    ...
    {
        Schema::dropIfExists('table_vendor_init');
    }
}
