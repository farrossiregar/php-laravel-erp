...
class CreateAccountPayableWeeklyopex extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('account_payable_weeklyopex', function (Blueprint $table) {
            $table->id();
            ...
            $table->char('admin_to_team', 30)->nullable();
            $table->char('difference_admin_team', 30)->nullable();
            $table->char('difference_hq_admin', 30)->nullable();
    ...
    {
        Schema::dropIfExists('account_payable_weeklyopex');
    }
}
